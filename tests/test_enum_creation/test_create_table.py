...
from tests.schemas import get_schema_with_enum_variants, USER_TABLE_NAME, USER_STATUS_ENUM_NAME, \
    ...
    CAR_COLORS_ENUM_NAME, USER_STATUS_COLUMN_NAME, ANOTHER_SCHEMA_NAME
...
def test_create_enum_on_create_table_with_another_schema_on_metadata(connection: 'Connection'):
