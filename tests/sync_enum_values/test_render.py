...
class TestAddNewEnumValueRender(CompareAndRunTestCase):
    ...
    def get_expected_upgrade(self) -> str:
        ...
        op.sync_enum_values(  # type: ignore[attr-defined]
            ...
            affected_columns=[TableReference(table_schema='{DEFAULT_SCHEMA}', table_name='{USER_TABLE_NAME}', column_name='{USER_STATUS_COLUMN_NAME}')],
...
class TestServerDefault(CompareAndRunTestCase):
    ...
    def get_expected_upgrade(self) -> str:
        ...
        op.sync_enum_values(
            ...
            affected_columns=[TableReference(table_schema='public', table_name='example_table', column_name='enum_field', existing_server_default="'one'::my_enum")],
            enum_values_to_rename=[],
        )
        # ### end Alembic commands ###
        """
