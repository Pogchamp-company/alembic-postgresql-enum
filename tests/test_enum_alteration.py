...
def test_add_new_enum_value_render(connection: 'Connection'):
    ...
    op.sync_enum_values('{DEFAULT_SCHEMA}', '{USER_STATUS_ENUM_NAME}', [{', '.join(map(repr, new_enum_variants))}], [('{USER_TABLE_NAME}', '{USER_STATUS_COLUMN_NAME}')],
      enum_values_to_rename=())
    # ### end Alembic commands ###""")
    assert (template_args["downgrades"] ==
            f"""# ### commands auto generated by Alembic - please adjust! ###
    op.sync_enum_values('{DEFAULT_SCHEMA}', '{USER_STATUS_ENUM_NAME}', [{', '.join(map(repr, old_enum_variants))}], [('{USER_TABLE_NAME}', '{USER_STATUS_COLUMN_NAME}')],
      enum_values_to_rename=())
    # ### end Alembic commands ###""")
