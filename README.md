...
- [alembic-postgresql-enum](#alembic-postgresql-enum)
  - [Usage](#usage)
  - [Features](#features)
  - [Creation of enum](#creation-of-enum)
    - [When table is created](#when-table-is-created)
    - [When column is added](#when-column-is-added)
  - [Deletion of unreferenced enum](#deletion-of-unreferenced-enum)
...
**_Can be disabled with `detect_enum_values_changes` configuration flag turned off_**

### Creation of new enum values<a id="creation-of-new-enum-values"></a>

If new enum value is defined, a sync_enum_values function call will be added to migration to account for it.
